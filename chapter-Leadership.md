...
<div class="wrapper">
  ...
  <div class="image-container-2">
    <figure class="image-item-2">
      <div class="text-content">
        ...
        <p>
          The job of Vice President is to assist the President and other officers in all of their duties and run officer and chapter meetings in the absence of the President. They oversee committees and project teams as well as set up communications for all committees. Unless the President is absent, the Vice President is responsible for taking meeting minutes. 
        </p>
  ...
  <!--Vice president of membership 2-->
  <div class="image-container-2">
    <figure class="image-item-2">
      <div class="text-content">
  ...
  <div class="image-container-2">
    <figure class="image-item-2">
      <div class="text-content">
        ...
        <h3>Mame Sakho</h3>
        <p>
          The job of Vice President of Public Relations is to manage all of the chapter’s official social media accounts and insure that all information gets to chapter members. They will highlight chapter activities and accomplishments, design and share announcements for chapter events, and document all meetings and activities. 
        </p>
  ...
  <div class="image-container-2">
    <figure class="image-item-2">
      <div class="text-content">
        ...
        <p>
          The job of Vice President of Competitive Events is to support members competing in competitive events. They will do this through helping members chose an event, planning STAR Event meetings and workshops, and creating a tracking system to help monitor progress.
        </p>
 ...
 <!--Vice president of Individual Programs -->
  <div class="image-container-2">
    <figure class="image-item-2">
      <div class="text-content">
        <h2>Vice President of Individual Programs</h2>
        <h3>Ellie Murphy</h3>
        <p>
          The job of Vice President of Competitive Events is to support members and encourage participation in individual programs and events. They will incorporate individual programs into chapter activities, host a fall workshop, and track participation in Power of One and other degrees.
        </p>
  ...
  <div class="image-container-2">
    <figure class="image-item-2">
      <div class="text-content">
        <h2>Vice President of Peer Education</h2>
        <h3>Eva Martinez-Limon</h3>
        <p>
          The job of Vice President of Peer Education is to inform others about what FCCLA is, promote FCCLA national programs and peer education initiatives, and help recruit members to participate in outreach and awareness activities. They will assist with chapter service projects and school-wide educational events including planning their own.
        </p>
