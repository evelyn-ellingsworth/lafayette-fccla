...
<script> var siteBaseUrl = "{{ site.baseurl }}"; 
  ...
  <div class="three-section-layout">
    ...
    <section class="column-1">
      ...
      <details>
        ...
        <details class="nested">
          <summary>Early Childhood Education (Level 3)</summary>
          <p1>Gold - Allison Padgett</p1>
          <p>An individual event - recognizes participants who demonstrate their ability to use knowledge and skills gained from their enrollment in an occupational early childhood program.</p>
        </details>

        <details class="nested">
          <summary>Interior Design (Level 3)</summary>
          <p1>Silver - Claire McNees and Emily Bethel</p1>
          <p>An individual or team event - recognizes participants who apply interior design skills learned in Family and Consumer Sciences courses to design to meet client needs.</p>
        </details>

        <details class="nested">
          <summary>Nutrition and Wellness (Level 2)</summary>
          <p1>Gold - Kaliyah Broadnax</p1>
        ...
        <details class="nested">
          <summary>Professional Presentation (Level 2)</summary>
          <p1>Gold - Abby Ledbetteer and Evelyn Ellingsworth</p1>
          <p>An individual or team event - recognizes participants who make an oral presentation about issues concerning Family and Consumer Sciences and/or related occupations.</p>
        </details>
    ...
    <section class="column-1">
      ...
      <details>
        <summary>2024-2025</summary>
        <details class="nested">
          <summary>Baking and Pastry (Level 3)</summary>
          <p1>Silver - Zoey Brady</p1>
      ...
      <details class="nested">
        ...
        <details class="nested">
          <summary>Culinary Arts (Level 3) </summary>
          <p1>Bronze - Joel Desmennu</p1>
          <p>An individual event - recognizes participants enrolled in occupational culinary arts/food service training programs for their ability to produce a quality meal using industrial culinary arts/food service techniques and equipment. </p>
        </details>
        ...
        <details class="nested">
          <summary>Professional Presentatoin (Level 2) </summary>
          <p1>Gold - Abby Ledbetter and Evelyn Ellingsworth</p1>
          <p>An individual or team event - recognizes participants who make an oral presentation about issues concerning Family and Consumer Sciences and/or related occupations. </p>
        </details>
    ...
    <section class="column-1">
      ...
      <details>
        ...
        <details class="nested">
          ...
          <details class="nested">
          <summary>Prgessional Presentation (Level 2)</summary>
          <p1>Gold - Abby Ledbetter and Evelyn Ellingsworth</p1>
          <p>An individual or team event - recognizes participants who make an oral presentation about issues concerning Family and Consumer Sciences and/or related occupations.</p>
          </details>
        </details>
